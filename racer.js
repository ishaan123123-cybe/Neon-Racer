function racer(gamemode) {
    ...
    var remainingTimeIncrease = 0.00003;                      // Multiplier of the trackLength to get seconds that will be added to the remainingTime, in other words this defines the time left to the player to finish the track proportionally to the track length (a higher value makes the game easier)
